  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dashboard — Mid-Day Meal Manager" },
      {
        ...
        content: "Live attendance, meal and budget figures for your school.",
      },
    ...
    <>
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          tone="success"
          loading={loadingDay}
          hint={day?.marked ? `${day.marked} marked` : "Not marked yet"}
        />
        <StatCard
          label="Absent today"
          value={day?.absent ?? 0}
      ...
      <section className="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard
          ...
          value={inr(todayTotal)}
          icon={IndianRupee}
          hint={todayExpense ? "Saved" : "Not recorded yet"}
        />
        <StatCard
        ...
        />
        <StatCard
          label="Monthly rice used"
          value={`${Math.round(monthlyRice * 1000) / 1000} kg`}
          icon={Wheat}
          tone="info"
      ...
      <section className="mt-3 grid gap-3 sm:grid-cols-2">
        <StatCard
          ...
          icon={IndianRupee}
          loading={loadingMonth}
          hint={`${monthExpenses?.length ?? 0} days recorded`}
        />
        <StatCard
      ...
      <section className="mt-4 grid gap-3 lg:grid-cols-2">
        <ChartCard
          ...
          subtitle="Present vs absent this month"
        ...
        <ChartCard
          ...
          subtitle="Daily spend against sanctioned budget"
          loading={loadingMonth}
        >
        ...
        <ChartCard
          ...
          subtitle="Kilograms issued per day"
          loading={loadingMonth}
        >
        ...
        <ChartCard
          title="Credits saved"
          subtitle="Budget minus actual expenditure"
          loading={loadingMonth}
        >
          <BarChart data={expenseSeries}>
            <CartesianGrid strokeDasharray="3 3" stroke="var(--color-border)" vertical={false} />
